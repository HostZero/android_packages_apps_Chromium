...
.method constructor <init>(Landroid/view/View;Landroid/transition/Transition;Ljava/util/ArrayList;Landroid/transition/Transition;Ljava/util/ArrayList;Landroid/transition/Transition;Ljava/util/ArrayList;Ljava/util/Map;Ljava/util/ArrayList;Landroid/transition/Transition;Landroid/view/View;)V
    ...
    .prologue
    .line 353
    iput-object p1, p0, Landroid/support/v4/app/H;->a:Landroid/view/View;

    iput-object p2, p0, Landroid/support/v4/app/H;->b:Landroid/transition/Transition;

    iput-object p3, p0, Landroid/support/v4/app/H;->c:Ljava/util/ArrayList;

    iput-object p4, p0, Landroid/support/v4/app/H;->d:Landroid/transition/Transition;

    iput-object p5, p0, Landroid/support/v4/app/H;->e:Ljava/util/ArrayList;

    iput-object p6, p0, Landroid/support/v4/app/H;->f:Landroid/transition/Transition;

    iput-object p7, p0, Landroid/support/v4/app/H;->g:Ljava/util/ArrayList;

    iput-object p8, p0, Landroid/support/v4/app/H;->h:Ljava/util/Map;

    iput-object p9, p0, Landroid/support/v4/app/H;->i:Ljava/util/ArrayList;

    iput-object p10, p0, Landroid/support/v4/app/H;->j:Landroid/transition/Transition;

    iput-object p11, p0, Landroid/support/v4/app/H;->k:Landroid/view/View;
...
.method public final onPreDraw()Z
    ...
    .line 356
    iget-object v0, p0, Landroid/support/v4/app/H;->b:Landroid/transition/Transition;
    ...
    .line 359
    :cond_0
    iget-object v0, p0, Landroid/support/v4/app/H;->d:Landroid/transition/Transition;
    ...
    .line 362
    :cond_1
    iget-object v0, p0, Landroid/support/v4/app/H;->f:Landroid/transition/Transition;
    ...
    iget-object v1, p0, Landroid/support/v4/app/H;->g:Ljava/util/ArrayList;

    invoke-static {v0, v1}, Landroid/support/v4/app/d;->a(Ljava/lang/Object;Ljava/util/ArrayList;)V

    .line 365
    :cond_2
    iget-object v0, p0, Landroid/support/v4/app/H;->h:Ljava/util/Map;
    ...
    .line 372
    iget-object v4, p0, Landroid/support/v4/app/H;->j:Landroid/transition/Transition;
    ...
    .line 374
    :cond_4
    iget-object v0, p0, Landroid/support/v4/app/H;->j:Landroid/transition/Transition;

    iget-object v1, p0, Landroid/support/v4/app/H;->k:Landroid/view/View;
