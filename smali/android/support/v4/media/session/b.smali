...
.method public constructor <init>()V
    ...
    invoke-virtual {p0, p0, v0}, Landroid/support/v4/media/session/b;->attachInterface(Landroid/os/IInterface;Ljava/lang/String;)V
...
.method public static a(Landroid/os/IBinder;)Landroid/support/v4/media/session/a;
    ...
    invoke-direct {v0, p0}, Landroid/support/v4/media/session/c;-><init>(Landroid/os/IBinder;)V
...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    .line 62
    :cond_0
    invoke-virtual {p0, v2, v0}, Landroid/support/v4/media/session/b;->a(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    .line 68
    invoke-virtual {p0}, Landroid/support/v4/media/session/b;->a()V
    ...
    .line 102
    invoke-virtual {p0, v0}, Landroid/support/v4/media/session/b;->a(Ljava/util/List;)V
    ...
    .line 115
    :cond_3
    invoke-virtual {p0, v0}, Landroid/support/v4/media/session/b;->a(Ljava/lang/CharSequence;)V
    ...
    .line 128
    :cond_4
    invoke-virtual {p0, v0}, Landroid/support/v4/media/session/b;->a(Landroid/os/Bundle;)V
    ...
    .line 141
    :cond_5
    invoke-virtual {p0, v0}, Landroid/support/v4/media/session/b;->a(Landroid/support/v4/media/session/ParcelableVolumeInfo;)V
