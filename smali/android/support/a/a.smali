...
.method static synthetic a(Ljava/lang/Object;Ljava/lang/String;[Ljava/lang/Class;)Ljava/lang/reflect/Method;
    ...
    .prologue
    .line 57
    invoke-static {p0, p1, p2}, Landroid/support/a/a;->b(Ljava/lang/Object;Ljava/lang/String;[Ljava/lang/Class;)Ljava/lang/reflect/Method;
...
.method public static a(Landroid/content/Context;)V
    ...
    const-string/jumbo v4, ": SDK version higher than 20"

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    const-string/jumbo v4, " should be backed by runtime with built-in multidex capabilty but it\'s not the "

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    const-string/jumbo v4, "case here: java.vm.version=\""
    ...
    const-string/jumbo v2, "Context class loader is null. Must be running in test mode. Skip patching."
    ...
    const-string/jumbo v3, "Failure while trying to obtain Context class loader. Must be running in test mode. Skip patching."
    ...
    invoke-static {p0, v0, v3, v4}, Landroid/support/a/d;->a(Landroid/content/Context;Landroid/content/pm/ApplicationInfo;Ljava/io/File;Z)Ljava/util/List;
    ...
    const-string/jumbo v5, "Something went wrong when trying to clear old MultiDex extraction, continuing without cleaning."
    ...
    const-string/jumbo v5, "Files were not valid zip files.  Forcing a reload."
...
.method private static a(Ljava/lang/ClassLoader;Ljava/io/File;Ljava/util/List;)V
    ...
    .line 242
    invoke-static {p0, p2, p1}, Landroid/support/a/c;->a(Ljava/lang/ClassLoader;Ljava/util/List;Ljava/io/File;)V
    ...
    .line 244
    invoke-static {p0, p2, p1}, Landroid/support/a/b;->a(Ljava/lang/ClassLoader;Ljava/util/List;Ljava/io/File;)V

    goto :goto_0

    .line 246
    :cond_2
    invoke-static {p0, p2}, Landroid/support/a/b;->a(Ljava/lang/ClassLoader;Ljava/util/List;)V
...
.method private static a(Ljava/util/List;)Z
    ...
    .line 257
    invoke-static {v0}, Landroid/support/a/d;->a(Ljava/io/File;)Z
