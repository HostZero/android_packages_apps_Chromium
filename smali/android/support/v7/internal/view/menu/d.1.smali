...
.field protected d:Landroid/support/v7/internal/view/menu/z;
...
.method public constructor <init>(Landroid/content/Context;II)V
    ...
    .line 60
    iput p2, p0, Landroid/support/v7/internal/view/menu/d;->g:I

    .line 61
    iput p3, p0, Landroid/support/v7/internal/view/menu/d;->h:I
...
.method public final a()Landroid/support/v7/internal/view/menu/y;
    ...
    .prologue
    .line 152
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/d;->f:Landroid/support/v7/internal/view/menu/y;
...
.method public a(Landroid/view/ViewGroup;)Landroid/support/v7/internal/view/menu/z;
    ...
    .prologue
    .line 73
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/d;->d:Landroid/support/v7/internal/view/menu/z;

    if-nez v0, :cond_0

    .line 74
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/d;->e:Landroid/view/LayoutInflater;

    iget v1, p0, Landroid/support/v7/internal/view/menu/d;->g:I
    ...
    iput-object v0, p0, Landroid/support/v7/internal/view/menu/d;->d:Landroid/support/v7/internal/view/menu/z;
...
.method public a(Landroid/support/v7/internal/view/menu/m;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    .prologue
    .line 177
    instance-of v0, p2, Landroid/support/v7/internal/view/menu/A;

    if-eqz v0, :cond_0

    .line 178
    check-cast p2, Landroid/support/v7/internal/view/menu/A;

    move-object v0, p2

    .line 182
    :goto_0
    invoke-virtual {p0, p1, v0}, Landroid/support/v7/internal/view/menu/d;->a(Landroid/support/v7/internal/view/menu/m;Landroid/support/v7/internal/view/menu/A;)V
...
.method public abstract a(Landroid/support/v7/internal/view/menu/m;Landroid/support/v7/internal/view/menu/A;)V
.end method
...
.method public final a(Landroid/support/v7/internal/view/menu/y;)V
    ...
    .prologue
    .line 148
    iput-object p1, p0, Landroid/support/v7/internal/view/menu/d;->f:Landroid/support/v7/internal/view/menu/y;
...
.method public a(Z)V
    ...
    .line 98
    instance-of v2, v3, Landroid/support/v7/internal/view/menu/A;

    if-eqz v2, :cond_5

    move-object v2, v3

    check-cast v2, Landroid/support/v7/internal/view/menu/A;

    invoke-interface {v2}, Landroid/support/v7/internal/view/menu/A;->a()Landroid/support/v7/internal/view/menu/m;
    ...
    .line 104
    invoke-static {v9}, Landroid/support/v4/view/ViewCompat;->w(Landroid/view/View;)V
    ...
    .line 1133
    :cond_3
    iget-object v1, p0, Landroid/support/v7/internal/view/menu/d;->d:Landroid/support/v7/internal/view/menu/z;
...
.method public a(Landroid/support/v7/internal/view/menu/C;)Z
    .locals 1
