...
# direct methods
.method constructor <init>(Landroid/widget/CompoundButton;Landroid/support/v7/internal/widget/L;)V
    .locals 2
    ...
    .line 53
    iput-object p1, p0, Landroid/support/v7/widget/v;->a:Landroid/widget/CompoundButton;

    .line 54
    iput-object p2, p0, Landroid/support/v7/widget/v;->b:Landroid/support/v7/internal/widget/L;
...
.method private b()V
    ...
    .prologue
    .line 116
    iget-object v0, p0, Landroid/support/v7/widget/v;->a:Landroid/widget/CompoundButton;
    ...
    iget-boolean v1, p0, Landroid/support/v7/widget/v;->e:Z

    if-nez v1, :cond_0

    iget-boolean v1, p0, Landroid/support/v7/widget/v;->f:Z
    ...
    .line 130
    iget-object v1, p0, Landroid/support/v7/widget/v;->a:Landroid/widget/CompoundButton;
...
.method final a()V
    ...
    iput-boolean v0, p0, Landroid/support/v7/widget/v;->g:Z
    ...
    .line 112
    invoke-direct {p0}, Landroid/support/v7/widget/v;->b()V
...
.method final a(Landroid/content/res/ColorStateList;)V
    ...
    .prologue
    .line 84
    iput-object p1, p0, Landroid/support/v7/widget/v;->c:Landroid/content/res/ColorStateList;
...
.method final a(Landroid/graphics/PorterDuff$Mode;)V
    ...
    .prologue
    .line 95
    iput-object p1, p0, Landroid/support/v7/widget/v;->d:Landroid/graphics/PorterDuff$Mode;
...
.method final a(Landroid/util/AttributeSet;I)V
    ...
    sget-object v1, Landroid/support/v7/a/a;->M:[I
    ...
    .line 61
    :try_start_0
    sget v0, Landroid/support/v7/a/a;->N:I
    ...
    .line 65
    iget-object v2, p0, Landroid/support/v7/widget/v;->a:Landroid/widget/CompoundButton;

    iget-object v3, p0, Landroid/support/v7/widget/v;->b:Landroid/support/v7/internal/widget/L;

    invoke-virtual {v3, v0}, Landroid/support/v7/internal/widget/L;->a(I)Landroid/graphics/drawable/Drawable;
    ...
    .line 68
    :cond_0
    sget v0, Landroid/support/v7/a/a;->O:I
    ...
    .line 72
    :cond_1
    sget v0, Landroid/support/v7/a/a;->P:I
    ...
    invoke-static {v0, v2}, Landroid/support/v4/widget/f;->a(Landroid/widget/CompoundButton;Landroid/graphics/PorterDuff$Mode;)V
    :try_end_0
