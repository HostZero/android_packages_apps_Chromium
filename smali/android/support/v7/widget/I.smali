...
.method public constructor <init>(Landroid/support/v7/widget/AppCompatSpinner;Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .prologue
    .line 688
    iput-object p1, p0, Landroid/support/v7/widget/I;->a:Landroid/support/v7/widget/AppCompatSpinner;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/I;->e:Landroid/graphics/Rect;
    ...
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/I;->a(Z)V

    .line 693
    const/4 v0, 0x0

    invoke-virtual {p0, v0}, Landroid/support/v7/widget/I;->a(I)V

    .line 695
    new-instance v0, Landroid/support/v7/widget/J;

    invoke-direct {v0, p0, p1}, Landroid/support/v7/widget/J;-><init>(Landroid/support/v7/widget/I;Landroid/support/v7/widget/AppCompatSpinner;)V

    invoke-virtual {p0, v0}, Landroid/support/v7/widget/I;->a(Landroid/widget/AdapterView$OnItemClickListener;)V

    .line 706
    return-void
.end method

.method static synthetic a(Landroid/support/v7/widget/I;)Landroid/widget/ListAdapter;
    .locals 1

    .prologue
    .line 683
    iget-object v0, p0, Landroid/support/v7/widget/I;->d:Landroid/widget/ListAdapter;

    return-object v0
.end method

.method static synthetic a(Landroid/support/v7/widget/I;Landroid/view/View;)Z
    .locals 1
    ...
    iget-object v0, p0, Landroid/support/v7/widget/I;->e:Landroid/graphics/Rect;
...
.method static synthetic b(Landroid/support/v7/widget/I;)V
    .locals 0

    .prologue
    .line 683
    invoke-super {p0}, Landroid/support/v7/widget/aj;->c()V
...
.method public final a()Ljava/lang/CharSequence;
    ...
    .prologue
    .line 715
    iget-object v0, p0, Landroid/support/v7/widget/I;->c:Ljava/lang/CharSequence;
...
.method public final a(Landroid/widget/ListAdapter;)V
    ...
    .line 711
    iput-object p1, p0, Landroid/support/v7/widget/I;->d:Landroid/widget/ListAdapter;
...
.method public final a(Ljava/lang/CharSequence;)V
    ...
    .prologue
    .line 720
    iput-object p1, p0, Landroid/support/v7/widget/I;->c:Ljava/lang/CharSequence;
...
.method final b()V
    ...
    .line 724
    invoke-virtual {p0}, Landroid/support/v7/widget/I;->d()Landroid/graphics/drawable/Drawable;
    ...
    .line 727
    iget-object v0, p0, Landroid/support/v7/widget/I;->a:Landroid/support/v7/widget/AppCompatSpinner;
    ...
    .line 738
    iget-object v2, p0, Landroid/support/v7/widget/I;->a:Landroid/support/v7/widget/AppCompatSpinner;
    ...
    iget-object v6, p0, Landroid/support/v7/widget/I;->a:Landroid/support/v7/widget/AppCompatSpinner;
    ...
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/I;->e(I)V
    ...
    invoke-virtual {p0}, Landroid/support/v7/widget/I;->h()I
    ...
    .line 731
    :cond_1
    iget-object v1, p0, Landroid/support/v7/widget/I;->a:Landroid/support/v7/widget/AppCompatSpinner;
...
.method public final c()V
    ...
    .prologue
    .line 761
    invoke-virtual {p0}, Landroid/support/v7/widget/I;->k()Z
    ...
    invoke-virtual {p0, v1}, Landroid/support/v7/widget/I;->f(I)V

    .line 766
    invoke-super {p0}, Landroid/support/v7/widget/aj;->c()V

    .line 767
    invoke-virtual {p0}, Landroid/support/v7/widget/I;->m()Landroid/widget/ListView;
    ...
    invoke-direct {v1, p0}, Landroid/support/v7/widget/K;-><init>(Landroid/support/v7/widget/I;)V
    ...
    invoke-direct {v0, p0, v1}, Landroid/support/v7/widget/L;-><init>(Landroid/support/v7/widget/I;Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;)V
