...
.field private e:Landroid/support/v7/widget/r;
...
.field private j:Landroid/support/v7/widget/I;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;IILandroid/content/res/Resources$Theme;)V
    ...
    .line 199
    sget-object v0, Landroid/support/v7/a/a;->bn:[I

    invoke-static {p1, p2, v0, p3, v7}, Landroid/support/v7/internal/widget/N;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/internal/widget/N;

    move-result-object v4

    .line 202
    invoke-virtual {v4}, Landroid/support/v7/internal/widget/N;->b()Landroid/support/v7/internal/widget/L;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v7/widget/AppCompatSpinner;->d:Landroid/support/v7/internal/widget/L;

    .line 203
    new-instance v0, Landroid/support/v7/widget/r;

    iget-object v2, p0, Landroid/support/v7/widget/AppCompatSpinner;->d:Landroid/support/v7/internal/widget/L;

    invoke-direct {v0, p0, v2}, Landroid/support/v7/widget/r;-><init>(Landroid/view/View;Landroid/support/v7/internal/widget/L;)V

    iput-object v0, p0, Landroid/support/v7/widget/AppCompatSpinner;->e:Landroid/support/v7/widget/r;
    ...
    invoke-direct {v0, p1, p5}, Landroid/support/v7/internal/view/a;-><init>(Landroid/content/Context;Landroid/content/res/Resources$Theme;)V
    ...
    invoke-direct {v0, p0, v2, p2, p3}, Landroid/support/v7/widget/I;-><init>(Landroid/support/v7/widget/AppCompatSpinner;Landroid/content/Context;Landroid/util/AttributeSet;I)V

    .line 244
    iget-object v2, p0, Landroid/support/v7/widget/AppCompatSpinner;->f:Landroid/content/Context;

    sget-object v5, Landroid/support/v7/a/a;->bn:[I

    invoke-static {v2, p2, v5, p3, v7}, Landroid/support/v7/internal/widget/N;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/internal/widget/N;

    move-result-object v2

    .line 246
    sget v5, Landroid/support/v7/a/a;->bo:I

    const/4 v6, -0x2

    invoke-virtual {v2, v5, v6}, Landroid/support/v7/internal/widget/N;->f(II)I
    ...
    .line 248
    sget v5, Landroid/support/v7/a/a;->bp:I

    invoke-virtual {v2, v5}, Landroid/support/v7/internal/widget/N;->a(I)Landroid/graphics/drawable/Drawable;

    move-result-object v5

    invoke-virtual {v0, v5}, Landroid/support/v7/widget/I;->a(Landroid/graphics/drawable/Drawable;)V

    .line 250
    sget v5, Landroid/support/v7/a/a;->bq:I

    invoke-virtual {v4, v5}, Landroid/support/v7/internal/widget/N;->d(I)Ljava/lang/String;

    move-result-object v5

    invoke-virtual {v0, v5}, Landroid/support/v7/widget/I;->a(Ljava/lang/CharSequence;)V

    .line 251
    invoke-virtual {v2}, Landroid/support/v7/internal/widget/N;->a()V

    .line 253
    iput-object v0, p0, Landroid/support/v7/widget/AppCompatSpinner;->j:Landroid/support/v7/widget/I;

    .line 254
    new-instance v2, Landroid/support/v7/widget/G;

    invoke-direct {v2, p0, p0, v0}, Landroid/support/v7/widget/G;-><init>(Landroid/support/v7/widget/AppCompatSpinner;Landroid/view/View;Landroid/support/v7/widget/I;)V

    iput-object v2, p0, Landroid/support/v7/widget/AppCompatSpinner;->g:Landroid/support/v7/widget/an;

    .line 270
    :cond_2
    invoke-virtual {v4}, Landroid/support/v7/internal/widget/N;->a()V
    ...
    .line 281
    :cond_3
    iget-object v0, p0, Landroid/support/v7/widget/AppCompatSpinner;->e:Landroid/support/v7/widget/r;
    ...
    .line 208
    :cond_4
    sget v0, Landroid/support/v7/a/a;->br:I

    invoke-virtual {v4, v0, v7}, Landroid/support/v7/internal/widget/N;->g(II)I
    ...
    invoke-direct {v0, p1, v2}, Landroid/support/v7/internal/view/a;-><init>(Landroid/content/Context;I)V
...
.method static synthetic a(Landroid/support/v7/widget/AppCompatSpinner;)Landroid/support/v7/widget/I;
    .locals 1

    .prologue
    .line 65
    iget-object v0, p0, Landroid/support/v7/widget/AppCompatSpinner;->j:Landroid/support/v7/widget/I;
...
.method public getDropDownVerticalOffset()I
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/I;->g()I
...
.method public getPopupBackground()Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/I;->d()Landroid/graphics/drawable/Drawable;
...
.method public getPrompt()Ljava/lang/CharSequence;
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/I;->a()Ljava/lang/CharSequence;
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .prologue
    .line 402
    iget-object v0, p0, Landroid/support/v7/widget/AppCompatSpinner;->g:Landroid/support/v7/widget/an;
...
.method public setAdapter(Landroid/widget/SpinnerAdapter;)V
    ...
    .line 387
    :goto_1
    iget-object v1, p0, Landroid/support/v7/widget/AppCompatSpinner;->j:Landroid/support/v7/widget/I;

    new-instance v2, Landroid/support/v7/widget/H;

    invoke-virtual {v0}, Landroid/content/Context;->getTheme()Landroid/content/res/Resources$Theme;

    move-result-object v0

    invoke-direct {v2, p1, v0}, Landroid/support/v7/widget/H;-><init>(Landroid/widget/SpinnerAdapter;Landroid/content/res/Resources$Theme;)V

    invoke-virtual {v1, v2}, Landroid/support/v7/widget/I;->a(Landroid/widget/ListAdapter;)V
...
.method public setDropDownHorizontalOffset(I)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/I;->b(I)V
...
.method public setDropDownVerticalOffset(I)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/I;->c(I)V
...
.method public setPrompt(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/I;->a(Ljava/lang/CharSequence;)V
